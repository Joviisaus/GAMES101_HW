...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
    ...
    projection = n*p*persp*projection;
...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    auto l1 = light{{20, 0, 0}, {500, 500, 500}};
    auto l2 = light{{-20, 0, 0}, {500, 500, 500}};
    ...
    for (auto& light : lights)
    {
        ...
        //std::cout<<kd.cwiseProduct((light.intensity*100 / d))[1]<<" "<<d<<std::endl;
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "../models/diablo3_pose/";

    // Load .obj File
    bool loadout = Loader.LoadFile("../models/diablo3_pose/diablo3_pose.obj");
    ...
    auto texture_path = "diablo3_pose_diffuse.tga";
    ...
    if (argc >= 2)
    {
        ...
        if (argc == 3 && std::string(argv[2]) == "texture")
        {
            ...
            texture_path = "african_head_SSS.jpg";
            r.set_texture(Texture(obj_path + texture_path));
        }
